...
def parsing():
    ...
    parser.add_argument('--mode', type=str, 
                        default='classification', help='must be mode of how model load.')
    # Optimizer Config
    ...
    parser.add_argument('--shift', default='gaussian_noise', type=str, help='Use cpu or cuda')
...
if __name__ == '__main__':
    ...
    np_train_img_path = f'/storage/users/makhavan/CSI/exp04/data_aug/CorCIFAR10_train/{args.shift}.npy'
    ...
    print(f"Loading {args.shift} shift as ood..")
