...
do 
    ...
    echo "$noise: $auc" >> shifts_in_svhn_out_binary.log
done
...
do 
    ...
    echo "$noise: $auc_scone" >> shifts_in_svhn_out_scone.log
done
...
auc=$(cat tmp_binary.log | grep "Evaluation/avg_auc:" | cut -d ':' -f2)
echo "cifar10: $auc" >> cifar10_in_svhn_out_binary.log
...
echo "cifar10: $auc" >> cifar10_in_svhn_out_scone.log
...
do 
    ...
    auc=$(cat tmp_binary.log | grep "Evaluation/avg_auc:" | cut -d ':' -f2)
    echo "$noise: $auc" >> cifar10_in_shifts_out_binary.log
done
...
do 
    ...
    auc_scone=$(cat tmp_scone.log | grep "Evaluation/avg_auc:" | cut -d ':' -f2)
    echo "$noise: $auc_scone" >> cifar10_in_shifts_out_scone.log
done
